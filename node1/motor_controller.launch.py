...
Launches the Pi4 motor controller node with a YAML parameter file.

Usage:
  ros2 launch pi4_motor_control motor_controller.launch.py
  ros2 launch pi4_motor_control motor_controller.launch.py params_file:=/path/to/custom.yaml
"""
