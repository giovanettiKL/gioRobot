...
ROS2 Humble — Robot Action Client Node
...
Usage:
  ros2 run pi4_motor_control robot_action_node

Send a goal from another terminal:
  # Move forward 1.0 m
  ros2 action send_goal /drive_action pi4_motor_control/action/Drive \
...
One-shot service call:
  ros2 service call /drive_command pi4_motor_control/srv/DriveCommand \
