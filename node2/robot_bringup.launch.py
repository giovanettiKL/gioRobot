...
Launches BOTH nodes together:
  1. motor_controller  — GPIO driver, subscribes /cmd_vel
  2. robot_action_node — action server, publishes /cmd_vel

Usage:
  ros2 launch pi4_motor_control robot_bringup.launch.py
  ros2 launch pi4_motor_control robot_bringup.launch.py demo_on_start:=true
"""
...
def generate_launch_description():
    pkg_share = FindPackageShare("pi4_motor_control")
